...
import { NewSiteCreationComponent } from 'app/entities/new-site-creation/new-site-creation.component';
...
describe('Component Tests', () => {
    describe('NewSiteCreation Management Component', () => {
        let comp: NewSiteCreationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [NewSiteCreationComponent],
                providers: [
                    {
                ...
                .overrideTemplate(NewSiteCreationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.newSiteCreations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
